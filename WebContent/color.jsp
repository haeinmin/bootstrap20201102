...
<div class="container mt-3">
	...
	<h1 class="bg-success">Maiores facilis quaerat.</h1>
	<h1 class="bg-info">Odit delectus fuga.</h1>
	<h1 class="bg-warning">Voluptatum dolorum eveniet!</h1>
	<h1 class="bg-danger text-white">Natus itaque quam.</h1>
	<h1 class="bg-secondary">Aliquid illo debitis?</h1>
	<h1 class="bg-dark">Natus eveniet blanditiis.</h1>
	<h1 class="bg-light">Assumenda commodi quasi.</h1>
</div>
</body>
</html>